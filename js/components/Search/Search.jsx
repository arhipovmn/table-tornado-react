...
export default class Table extends React.Component {
    ...
    onSearch(selectAutocomplete = this.state.textSearch) {
    ...
    render() {
        ...
        return <form onSubmit={e => {
            ...
            <Autocomplete
                ...
                renderItem={(item, isHighlighted) => {
                    ...
                    return this.state.fetching
                        ...
                        : <div className={classNames(isHighlighted ? style['active'] : null, style['item'])}>
                            <div>Номер заказа <span>{item.number}</span>{<span>, {searchColumn(item.column)}</span>}
                            </div>
                ...
                onSelect={selectAutocomplete => ::this.onSearch(selectAutocomplete)}/>
        </form>;
    };
}