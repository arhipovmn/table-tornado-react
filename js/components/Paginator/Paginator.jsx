        ...
        return <div className={style['paginator']}>
            ...
            <div>
                ...
                {this.props.currentPage + 6 <= this.props.countPage
                    ? <span>...</span> : null}
                {this.props.currentPage + 6 <= this.props.countPage
                    ? <Link to={`/${this.props.page}/${this.props.countPage}`}
